...
public class ReadFromFile {
	...
	public static List readFileByLines(String fileName) {
		...
		try {
			...
			try {
				reader=new BufferedReader(new InputStreamReader(new FileInputStream(file),codeString(fileName)));
			} catch (Exception e) {
	...
	public static List readFileByLines(String fileName,String fileEncode) {
