...
public class DatabaseMetaDateApplication {
	...
	public DatabaseMetaDateApplication(Connection conn) {
		this.getDatabaseMetaData(conn);
	}
	 ...
	 * 获得数据库的一些相关信息
	 */
	public Map getDataBaseInformations() {
		Map  DataBaseInformations=new HashMap();
		try {			
			System.out.println("数据库已知的用户: "+ dbMetaData.getUserName());  
			DataBaseInformations.put("UserName", dbMetaData.getUserName());
            ...
            DataBaseInformations.put("DatabaseProductName", dbMetaData.getDatabaseProductName());
            
            System.out.println("数据库的版本:" + dbMetaData.getDatabaseProductVersion());  
            DataBaseInformations.put("DatabaseProductVersion", dbMetaData.getDatabaseProductVersion());
            
            
            System.out.println("驱动程序的名称:" + dbMetaData.getDriverName());  
            DataBaseInformations.put("DriverName", dbMetaData.getDriverName());
            
            System.out.println("驱动程序的版本:" + dbMetaData.getDriverVersion()); 
            DataBaseInformations.put("DriverVersion", dbMetaData.getDriverVersion());
	 ...
	 * @return 
	 */
	public ArrayList getAllTableList(String schemaName) {
	...
	public static void main(String[] args) {
		...
		DatabaseMetaDateApplication metaData = new DatabaseMetaDateApplication(conn);
		metaData.getDataBaseInformations();
		metaData.getTableColumns(null, "hzx_attence_user");
